...
public class MixinRedstoneOreBlock extends Block implements ISwitchableBlock {
    @Shadow @Final
    private boolean isOn;

    public MixinRedstoneOreBlock(Material blockMaterialIn, MapColor blockMapColorIn) {
