...
public class MixinRedstoneTorchBlock extends Block implements ISwitchableBlock {
    @Shadow @Final
    private boolean isOn;

    public MixinRedstoneTorchBlock(Material blockMaterialIn, MapColor blockMapColorIn) {
    ...
    public TileEntity createTileEntity(World world, IBlockState state){
        return new SwitchableRedstoneDummy((ILightProviderBlock) this);
